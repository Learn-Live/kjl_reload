...
def main(dataset_name="CTU1", model_name="OCSVM(rbf)", feat_set='iat_size', is_gs=True, start_time=None):
    """
...
if __name__ == '__main__':
    for dataset_name, model_name in itertools.product(DATASETS, ALL_MODELS):
        main(dataset_name=dataset_name, model_name=model_name, start_time=None, is_gs=True)
        main(dataset_name=dataset_name, model_name=model_name, start_time=None, is_gs=False)
